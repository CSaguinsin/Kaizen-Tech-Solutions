    ...
    <div>
      <div className="max-w-7xl mx-auto mt-20">
        <div className="text-center mb-12">
          <h1 className="font-[inter] text-6xl font-bold mb-4 text-black dark:text-white">
      ...
      <div className="w-full mt-20">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 my-20">
          <section className="mt-20 flex flex-col">
            <div>
              <h1 className="text-center text-black dark:text-white  font-bold font-[inter] text-5xl">
                Meet our Team!
              </h1>
            </div>
      ...
      <div className="w-full bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-20">
          <div>
            <h1 className="text-center font-bold text-5xl font-[inter] text-black dark:text-white">
